...
tic("Preparing data")
measurement_id = "000012115203__2022-01-12T12_49_33-Measurement_3"

bucket_dir = "s3://ascstore/flatfield/"
...
observation <- tbl(pool.v2, "observation") %>% 
  head(10000) %>% 
  filter(!grepl("000012113403__2021-09-23T13_58_29-Measurement_2",id_observation)) %>% 
  collect()
na_s <- observation[rowSums(is.na(observation)) > 0,]
```

...
cat(session_id, "measurement (well-site) count:", measurement_count, "||","timepoint count:", unique_timepoint_count, "||", "observation unique measurement count:", obs_count, sep = "  ")
cat("\n")

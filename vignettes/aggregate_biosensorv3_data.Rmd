...
Connects to biosensorv3 database. It contains the single-cell morphological data produced by the updated image analysis pipeline (CellProfiler 4.0.6 and Distributed CellProfiler 2.0.0)

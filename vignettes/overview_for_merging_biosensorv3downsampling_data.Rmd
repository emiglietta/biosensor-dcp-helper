...
```{r eval=FALSE, include=FALSE}
# tic()
# deleteQuery <- glue::glue_sql("DELETE FROM measurement WHERE id_measurement LIKE '%000012118003__2023-05-21T14_47_08-Measurement_3%'", .con=pool.v3)
# dbExecute(statement = deleteQuery, con=pool.v3)
# toc()
# tic()
# deleteQuery <- glue::glue_sql("DELETE FROM observation WHERE id_observation LIKE '%000012118003__2023-05-21T14_47_08-Measurement_3%'", .con=pool.v3)
# dbExecute(statement = deleteQuery, con=pool.v3)
# toc()
```
...
measurement_id_to_truncate <- "000012118003__2023-05-21T14_47_08-Measurement_3"
...
# for (feature_group in c("areashape", "ch2", "ch3", "ch4", "ch5", "ch6")) {
#   tic()
#   deleteQuery <- glue::glue_sql("DELETE FROM observation_{feature_group} WHERE id_observation LIKE '{measurement_id_to_truncate}'", .con=pool.v3.ds)
#   dbExecute(statement = deleteQuery, con=pool.v3.ds)
#   toc()
# }
# 
# deleteQuery <- glue::glue_sql("DELETE FROM observation_areashape WHERE id_observation LIKE '%000012117203__2023-03-14T12_32_09-Measurement_2%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch2 WHERE id_observation LIKE '%000012117203__2023-03-14T12_32_09-Measurement_2%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch3 WHERE id_observation LIKE '%000012117203__2023-03-14T12_32_09-Measurement_2%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch4 WHERE id_observation LIKE '%000012117203__2023-03-14T12_32_09-Measurement_2%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch5 WHERE id_observation LIKE '%000012117203__2023-03-14T12_32_09-Measurement_2%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch6 WHERE id_observation LIKE '%000012117203__2023-03-14T12_32_09-Measurement_2%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# toc()
```

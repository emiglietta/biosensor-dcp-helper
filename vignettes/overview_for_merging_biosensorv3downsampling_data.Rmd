...
measurement_id_to_truncate <- "000012118303__2023-06-02T13_16_13-Measurement_1"
...
tic()
# deleteQuery <- glue::glue_sql("DELETE FROM observation_areashape WHERE id_observation LIKE '%000012118303__2023-06-02T13_16_13-Measurement_1%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch2 WHERE id_observation LIKE '%000012118303__2023-06-02T13_16_13-Measurement_1%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch3 WHERE id_observation LIKE '%000012118303__2023-06-02T13_16_13-Measurement_1%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch4 WHERE id_observation LIKE '%000012118303__2023-06-02T13_16_13-Measurement_1%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch5 WHERE id_observation LIKE '%000012118303__2023-06-02T13_16_13-Measurement_1%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
# deleteQuery <- glue::glue_sql("DELETE FROM observation_ch6 WHERE id_observation LIKE '%000012118303__2023-06-02T13_16_13-Measurement_1%'", .con=pool.v3.ds)
# dbExecute(statement = deleteQuery, con=pool.v3.ds)
toc()
```

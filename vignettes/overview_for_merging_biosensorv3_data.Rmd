---
title: "overview_for_merging_biosensorv3_data"
author: "mcsaba"
date: "11/2/2021"
...
tic("Preparing data")
measurement_id = "000012116603__2023-01-20T18_18_37-Measurement_1"
...
# observation %>% head(10) %>% collect()
```

!!! DANGEROUS COMMANDS !!!

```{r}
# deleteQuery <- glue::glue_sql("DELETE FROM measurement WHERE id_measurement LIKE '%000012115503__2022-02-11T15_01_56-Measurement_4%'", .con=pool.v2)
# dbExecute(statement = deleteQuery, con=pool.v2)
# 
# deleteQuery <- glue::glue_sql("DELETE FROM observation WHERE id_observation LIKE '%000012115503__2022-02-11T15_01_56-Measurement_4%'", .con=pool.v2)
# dbExecute(statement = deleteQuery, con=pool.v2)
```

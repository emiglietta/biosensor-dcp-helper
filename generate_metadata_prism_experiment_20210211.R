...
## Call this script with: Rscript generate_metadata_prism_experiment.R {plate_names}

library(tidyverse)
library(dcphelper)
library(tictoc)

format_output_structure <- function(metadata_tags){ paste0(metadata_tags, collapse = "-") }
...
path_yml = "~/mcsaba/biosensor/src/dcp_helper/python/pe2loaddata_config_12109403.yml"
...
new_json_path_brightfield_flatfield = "~/dcp_helper/python/job_brightfield_flatfield_prism_template.json" #brightfield FFC
# new_json_path_fluorescent_flatfield = "~/dcp_helper/python/job_fluorescent_flatfield_template.json" #fluorescent FFC

new_json_path_brightfield_projection = "~/dcp_helper/python/job_brightfield_projection_prism_template.json" #fluorescent projection
# new_json_path_fluorescent_projection = "~/dcp_helper/python/job_fluorescent_projection_template.json" #fluorescent projection

new_json_path_segmentation = "~/dcp_helper/python/job_segmentation_prism_template.json"
new_json_path_featureextraction_ch2 = "~/dcp_helper/python/job_featureextraction_ch2_prism_template.json"
...
fileConn <- file("/home/ubuntu/mcsaba/metadata_generation_prism.log")
...
# Name of channels
channel_ffc_v <- c("ch2")
channel_ffc_n <- c("ffc_brightfield")
...
#==================================================#
#        PHASE 2.2: bright-field projections       #
#==================================================#
...
projection_subsets <- list(
  resolution1 = lapply(seq(1,15,by=1), sprintf, fmt=plane_format)#,
